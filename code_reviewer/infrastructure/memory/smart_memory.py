...
class SmartMemoryStrategy(MemoryStrategy):
    ...
    def summarize_if_needed(self) -> bool:
        ...
        logger.info(
            "Memory summarisation triggered",
            extra={"fields": {"used": self.total_tokens_used, "budget": self.max_tokens}},
        )
        ...
        if (
            self.total_tokens_used > critical_threshold
            and self.high_insights
            and len(self.high_insights) > 10
        ):
