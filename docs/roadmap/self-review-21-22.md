...
|---|---|---|---|---|
| S-01 | 🔴 High | `domain/narration.py` | `the_prose_claims_no_verdict` catches 3 of 8 natural phrasings. "This blocks the pipeline", "this merge request is blocked", "LGTM, approved" and "do not merge" all pass. | open |
...
| S-04 | 🟠 Medium | `domain/narration.py` | `severity_claims_are_backed` fires on the word "high" anywhere in the prose. "The function has high complexity" fails a review that said nothing wrong. | open |
